            ...
            <div className='w-full lg:w-[80%] min-h-[180vh] md:min-h-[120vh] pl-[66px] pt-[40px] '>
                <div>
                    <div className='flex lg:gap-10'>
                        ...
                        <div className='mt-4 text-[#067647]  border-[#DC4A2D]'>{data.IsOpen}</div>
                    </div>
                ...
                <div className='flex flex-col md:flex-row md:gap-10' >
                    <div className='flex flex-col' >
                        <p>Skills Required</p>
                        <ul>
                            <li className='flex gap-2 border-[1px] rounded-md mt-1 mb-1 p-1'><img src={FigmaLogo}/> Figma</li>
                            <li className='flex gap-2 border-[1px] rounded-md mb-1 p-1'><img src={AdobeLogo}/> Adobe Illustrator</li>
                            <li className='flex gap-2 border-[1px] rounded-md mb-1 p-1'><img src={XDLogo}/> Adobe XD</li>
                        </ul>
                    </div>
